...
SET BITS=64
SET USER_JDK64_FILE=%USERPROFILE%\.PyCharm2018.2\config\pycharm%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%USERPROFILE%\.PyCharm2018.2\config\pycharm%BITS%.exe.jdk
...
IF NOT EXIST "%VM_OPTIONS_FILE%" (
  :: user-overridden
  SET VM_OPTIONS_FILE=%USERPROFILE%\.PyCharm2018.2\config\pycharm%BITS%.exe.vmoptions
)
IF NOT EXIST "%VM_OPTIONS_FILE%" (
...
SET COMMON_JVM_ARGS="-XX:ErrorFile=%USERPROFILE%\java_error_in_PYCHARM_%%p.log" "-XX:HeapDumpPath=%USERPROFILE%\java_error_in_PYCHARM.hprof" -Didea.paths.selector=PyCharm2018.2 %IDE_PROPERTIES_PROPERTY%
